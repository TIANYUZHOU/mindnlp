...
class SentimentAnalysisWork(Work):
    ...
    def _construct_model(self, model):
        ...
        model_path = os.path.join(self._work_path, "model_state.ckpt")
    ...
    def _construct_tokenizer(self, model):
        ...
        """
        vocab_path = os.path.join(self._work_path, "vocab.txt")
    ...
    def _batchify_fn(self, samples):
        ...
        outputs = []
        pader = PadTransform(max_length=max_length, pad_value=self.kwargs["pad_token_id"])
